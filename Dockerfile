...
RUN apt-get add-apt-repository ppa:ondrej/php && apt-get update --fix-missing && apt-get -y --force-yes upgrade && apt-get install -y --force-yes supervisor curl redis-server nginx php7.3 php7.3-common php7.3-cli
